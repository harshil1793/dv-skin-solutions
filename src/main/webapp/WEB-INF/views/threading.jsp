...
<head>
    ...
    <title>DV skin Solutions | Threading</title>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="promo-block">
              <div class="promo-text">Threading</div>
  					...
  					<table class="table table-striped marg30">
    					<tbody>
      						<tr >
        						...
        						<td ><b>Time:</b> 15 Mins, <b>Price:</b> $10+</td>
        						<td></td>
      						</tr>
      						<tr>
        						<td><p style="font-size:20px">Side Face</p>
        						<td ><b>Time:</b> 10 Mins, <b>Price:</b> $15+</td>
        						<td></td>
      						</tr >
      						<tr >
        						<td><p style="font-size:20px">Full Face</p>
        						<td ><b>Time:</b> 20 Mins, <b>Price:</b> $20+</td>
        						<td></td>
      						</tr>
      						<tr >
        						<td><p style="font-size:20px">Upper Lip</p>
        						<td ><b>Time:</b> 10 Mins, <b>Price:</b> $6+</td>
        						<td></td>
      						</tr >
      						<tr >
        						<td><p style="font-size:20px">fore Head</p>
        						<td ><b>Time:</b> 10 Mins, <b>Price:</b> $8+</td>
        						<td></td>
      						</tr>
      						...
      						<tr>
        						<td><p style="font-size:20px">Eyebrow tinting</p>
        						<td ><b>Time:</b> 15 Mins, <b>Price:</b> $10+</td>
        						<td></td>
      						</tr>
