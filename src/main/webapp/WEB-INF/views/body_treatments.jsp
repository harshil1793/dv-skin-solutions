...
<head>
    ...
    <title>DV skin Solutions | Body Treatments</title>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="promo-block">
              <div class="promo-text">Body Treatments</div>
        ...
        <div class="row marg30">
            ...
            <div class="neighborhood-guides" >
                <div class="container">
                    ...
                    <div class="row ">
                        <h2>Slimming Body Wrap </h2>
                        <div class="col-md-8 learn-more ">
                            <p>Traditional mummy style body wrap using special aloe vera and herbs solution. This cocooning wrap treatment benefits hydration, relaxation, skin toning, detoxification and/or heat therapy for fibromyalgia or joint discomfort.</p>
                        </div>
                        <div class="col-md-3">
                            <p>Time <span>  60 Mins</span></p>
            ...
            <div class="neighborhood-guides" >
                <div class="container">
                    ...
                    <div class="row ">
                        <h2>Seaweed Body Wrap</h2>
                        <div class="col-md-8 learn-more ">
                            <p>Seaweed body wrap helps exfoliate dry and damaged skin to improve hydration and release stress and toxins from the entire body. </p>
                        </div>
                        <div class="col-md-3">
                            <p>Time <span>  60 Mins</span></p>
                            <p>Price <span>  $75 </span></p>
            ...
            <div class="neighborhood-guides" >
                <div class="container">
                    ...
                    <div class="row ">
                        <h2>Aromatherapy Salt Glow </h2>
                        <div class="col-md-8 learn-more ">
                            <p>Aromatherapy Salt Glow is a service that utilizes sea salt to exfoliate, help circulation, replenish minerals, open pores, and give skin a healthy glow.</p>
                        </div>
                        <div class="col-md-3">
                            <p>Time <span>  60 Mins</span></p>
