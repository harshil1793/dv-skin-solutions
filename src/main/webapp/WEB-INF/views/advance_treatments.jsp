...
<head>
    ...
    <title>DV skin Solutions | Advance Threatments</title>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="promo-block">
              <div class="promo-text">Advanced Treatments</div>
        ...
        <div class="row marg30">
            ...
            <div class="neighborhood-guides" >
                <div class="container">
                    ...
                    <div class="row ">
                        <h2>Chemical Peels: Glycolic / Lactic / Salicylic Acid Peels </h2>
                        <div class="col-md-8 learn-more ">
                            <p>Chemical peel is an advance treatment to exfoliate dead skin with help of acid to improve tone and texture of skin, and helps reduce fine lines and wrinkles.</p>
                        </div>
                        <div class="col-md-3">
            ...
            <div class="neighborhood-guides" >
                <div class="container">
                    ...
                    <h2>Microdermabrasion</h2>
                        <div class="col-md-8 learn-more ">
                            <p>Aggressive  exfoliation is done with help of dimond tips to improve hyperpigmentation, uneven skin tone, Acne scars, fine lines, and wrinkles.</p>
                        </div>
                        <div class="col-md-3">
                            <p>Time <span>  60 Mins</span></p>
                            <p>Price <span>  $85 </span></p>
