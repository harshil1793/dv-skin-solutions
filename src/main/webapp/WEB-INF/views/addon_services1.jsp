...
<head>
    ...
    <title>DV skin Solutions | Addon Services</title>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="promo-block">
              <div class="promo-text">Addon Services</div>
        ...
        <div class="row marg30">
            ...
            <div class="neighborhood-guides" >
                ...
                <div class="col-md-6 col-md-offset-3">      
  					<table class="table table-striped marg30">
    					<tbody>
      						<tr >
        						<td><p style="font-size:20px">Skin Lightning Services</p>
        						
        						<td ><b>Price:</b> $20</td>
        						<td></td>
      						</tr>
      						<tr>
        						<td><p style="font-size:20px">Icon tour</p>
        						<td ><b>Time:</b> 20 Mins, <b>Price:</b> $25+</td>
        						<td></td>
      						</tr >
      						<tr >
        						<td><p style="font-size:20px">Under Arm</p>
        						<td ><b>Time:</b> 20 Mins, <b>Price:</b> $20+</td>
        						<td></td>
      						</tr>
      						<tr >
        						<td><p style="font-size:20px">Full Leg</p>
        						<td ><b>Time:</b> 20 Mins, <b>Price:</b> $60+</td>
        						<td></td>
      						</tr >
      						<tr >
        						<td><p style="font-size:20px">Half Leg</p>
        						<td ><b>Time:</b> 20 Mins, <b>Price:</b> $35+</td>
        						<td></td>
      						</tr>
      						<tr>
        						<td><p style="font-size:20px">Bikini</p>
        						<td ><b>Time:</b> 20 Mins, <b>Price:</b> $30+</td>
        						<td></td>
      						</tr>
      						
      						<tr >
        						<td><p style="font-size:20px">Brazilian Bikini</p>
        						<td ><b>Time:</b> 20 Mins, <b>Price:</b> $60+</td>
        						<td></td>
      						</tr>
      						<tr>
        						<td><p style="font-size:20px">Back Wax</p>
        						<td ><b>Time:</b> 20 Mins, <b>Price:</b> $50+</td>
        						<td></td>
      						</tr>
      						<tr>
        						<td><p style="font-size:20px">Eyebrow</p>
        						<td ><b>Time:</b> 20 Mins, <b>Price:</b> $10+</td>
        						<td></td>
      						</tr>
      						<tr>
        						<td><p style="font-size:20px">Lip</p>
        						<td ><b>Time:</b> 20 Mins, <b>Price:</b> $6+</td>
        						<td></td>
      						</tr>
      						<tr>
        						<td><p style="font-size:20px">Chin</p>
        						<td ><b>Time:</b> 20 Mins, <b>Price:</b> $6+</td>
        						<td></td>
      						</tr>
      						<tr>
        						<td><p style="font-size:20px">Chest Wax</p>
        						<td ><b>Time:</b> 20 Mins, <b>Price:</b> $40+</td>
        						<td></td>
      						</tr>
      						<tr>
        						<td><p style="font-size:20px">Side Face Wax</p>
        						<td ><b>Time:</b> 20 Mins, <b>Price:</b> $10+</td>
        						<td></td>
      						</tr>
    					</tbody>
